...
Looking for random relationships between a response and a large number of predictors is called data mining (or the more sinister term "data manipulation") and it can lead to very misleading results. In fact, data mining has been the downfall of more than one researcher over the years^[One of the most publicizied was the "food guy" Brian Wansink; [read more here](https://www.vox.com/science-and-health/2018/9/19/17879102/brian-wansink-cornell-food-brand-lab-retractions-jama)]. I have read plenty of papers myself that look at a bunch of random correlations, find some that are significant by chance, and move on, feeling good about themselves for discovering new false patterns in the universe.
