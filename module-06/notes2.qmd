...
1. Perform a 70-30 training split on the Penguins dataset using `set.seed(55)` for consistency. Fit a classification tree to the training set and plot the resulting tree
