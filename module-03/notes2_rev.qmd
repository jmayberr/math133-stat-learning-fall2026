...
<iframe src="https://jmayberry.shinyapps.io/logistic-explorer" width="100%" height="400px">
...
<iframe src="https://jmayberry.shinyapps.io/logistic-shots" width="100%" height="400px">
...
Now if we denote our two predictors as $X,Y$ (to correspond with our usually labelling of axes in two-dimensions and coincidentally, the two predictors in our water polo example) the decision boundary is the equation
...
Note however that `xj` wasn't significant since it isn't actually horizontal distance but rather relative position. If we use absolute value instead, we get a better model and a more reasonable decision boundary:
