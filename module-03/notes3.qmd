...
- A **93.8% chance** of correctly detecting antibodies in someone who has had COVID (this is called *recall* or *sensitivity* or *true positive* rate[^1])
...
[^1]: Its annoying that there are so many names for these terms but that just tells you the concepts are important! They have appeared across many different applications leading to the independent development of different terminologies.

We can organize the results of testing everyone in town into a **confusion matrix** where the rows tell the truth and the columns tell us the predictions[^2]

[^2]: Although be careful of always assuming this orientation. You'll see examples where truth and predictions are switched!
...
[^3]: Yet another metric we won't cover in these notes are *Brier Scores*, defined as the MSE between the predicted probabilities and the actual binary values. I put the name here so you know what it is if you see it in future performance analysis ventures.
