...
of all patients had CHD so it is better to use stratified sampling in this scenaior
...
## Bonus: ROC curves^[Yet another metric we won't cover in these notes are _Brier Scores_, defined as the MSE between the predicted probabilities and the actual binary values. I put the name here so you know what it is if you see it in future performance analysis ventures. ]
