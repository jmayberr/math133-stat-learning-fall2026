...
Since we cannot rely on simulations like this for real data[^3], classical statistics gives us a formula for the standard error of $\hat \beta_1$[^4]: $$SE(\hat \beta_1)= \sigma/\sqrt{\sum (x_i-\bar{x})^2}$$
...
Import the dataset [Beerwings.csv](https://raw.githubusercontent.com/jmayberr/math133-stat-learning-fall2026/refs/heads/main/Datasets/Beerwings.csv) (Source: [Mathematical Statistics with Resampling and R](https://bcs.wiley.com/he-bcs/Books?action=index&itemId=1119874033&bcsId=12641)) and complete the following steps. Note that *Beer* measures beer consumed in ounces and *Hotwings* measures number of hotwings consumed per individual.

1.  Create a scatterplot of *Beer* (y-axis) vs *Hotwings* (x-axis) with nicely labeled axes titles and an added trendline (you may have already done this if you read the rtools supplement)
2.  Fit an SLM to these two variables using *Beer* as the outcome. Display the summary.
