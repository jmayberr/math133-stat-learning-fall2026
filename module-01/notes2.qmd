...
1.  Create a scatterplot of Hotwings (y-axis) vs Beer (x-axis) with nicely labeled axes titles and an added trendline.
2.  Fit a linear model Hotwings \~ Beer and show the coefficients.
3.  Compute the RMSE for the linear model.
4.  Add a color aesthetic of "Gender" to your plot. Compare the trendlines shown in the graph. Do they appear to have different slopes or intercepts?
